...
import com.github.gkane1234.fluidsimulation.Measurements.PressureMeasurement;
...
public class PressureForce extends GridForce {
    ...
    public Vector2D calculateForce(Particle p, Particle neighbor, double smoothingWidth) {
        ...
        double pressureMagnitude = PRESSURE_FACTOR_MULTIPLIER*neighbor.getMass()*(forceConstant*(neighbor.getMeasurement("Density")+p.getMeasurement("Density"))/(2*neighbor.getMeasurement("Density")));
